...
#define STRING_CONFIG_H_AUTHOR "(pavvlik777, K3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "EasyThreed K3"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 112, 112, 1200, 93 }
